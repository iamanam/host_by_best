<?php
function easyweb_webnus_gmap ($atts, $content = null) {
	...
	<div class="w-map"><div id="gmap<?php echo esc_attr($id); ?>" style="<?php echo esc_attr($width) ?><?php echo esc_attr($height) ?>"></div></div>
	<script type="text/javascript">
	jQuery(document).ready(function($) {
		jQuery("#gmap<?php echo esc_attr($id); ?>").gMap({
		    zoom: <?php echo $zoom ?>,
...
add_shortcode('gmap','easyweb_webnus_gmap');
