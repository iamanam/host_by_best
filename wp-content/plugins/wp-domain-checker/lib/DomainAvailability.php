...
class DomainAvailability {
	...
	public function is_available($domain) {
		...
		$whois_arr = array(
			...
			"vlaanderen" => array("whois.nic.vlaanderen", "No match"),
			"brussels" => array("whois.nic.brussels", "No match"),
			"gent" => array("whois.nic.gent", "NOT AVAILABLE"),
			"gratis" => array("whois.nic.gratis", "NDomain not found"),
			"website" => array("whois.nic.website", "DOMAIN NOT FOUND"),
			"immo" => array("whois.nic.immo", "Domain not found"),
			...
			"business" => array( "whois.nic.business", "Domain not found"),
			"ltda" => array( "whois.nic.ltda", "NOT FOUND"),
			"fashion" => array( "whois.nic.fashion", "Not Registered"),
			"flowers" => array( "whois.nic.flowers", "is available for registration"),
			"garden" => array( "whois.nic.garden", "Not Registered"),
			"green" => array( "whois.nic.green", "NOT FOUND"),
			"wedding" => array( "whois.nic.wedding", "Not Registered"),  
			"design" => array("whois.nic.design", "DOMAIN NOT FOUND"),
			"auction" => array("whois.nic.auction", "Domain not found"),
			...
			"cricket" => array("whois.nic.cricket", "Not found:"),
			"delivery" => array("whois.nic.delivery", "Domain not found"),
			"energy" => array("whois.nic.energy", "Domain not found"),
			"lgbt" => array("whois.nic.lgbt", "NOT FOUND"),
			"party" => array("whois.nic.party", "Not found:"),
			"science" => array("whois.nic.science", "Not found:"),
			"vote" => array("whois.nic.vote", "NOT FOUND"),
			"yoga" => array("whois.nic.yoga", "Not Registered"),  
			"cymru" => array("whois.nic.cymru", "domain name has not been registered"),
			"wales" => array("whois.nic.wales", "domain name has not been registered"),
			"market" => array("whois.rightside.co","Domain not found"), 
			"golf" => array("whois.donuts.co","Domain not found."), 
			...
			"org.za" => array("org-whois1.registry.net.za","Available"),
			"net.za" => array("net-whois1.registry.net.za","Available"),
			"co.za" => array("whois.registry.net.za","Available"),
			"corsica" => array("whois-corsica.nic.fr","Requested Domain cannot be found"),
			"work" => array("whois.nic.work","Not Registered"),
			"buzz" => array("whois.nic.buzz","Not found"),  
			"lawyer" => array("whois.rightside.co","Not Registered"),
			"attorney" => array("whois.rightside.co","Not Registered"),
