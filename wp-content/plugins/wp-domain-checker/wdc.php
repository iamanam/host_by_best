...
if(isset($_POST['domain']))
{
	...
	if(strlen($punny_domain) > 0)
	{
		...
		if($whois > 1) {
				$whois_link = "<a href='".get_permalink($whois)."?&domain=$domain' ".$whois_new_tab." ><button class='btn btn-danger btn-xs pull-right whois-btn'>WHOIS</button></a>";
			}else{
				$whois_link = '';
			}
...
if(count($check_ex) == 2){
	...
	$ex_name = $check_ex[0];
			...
			$additional_button = "<a href='?&add-to-cart=$additional_button_link&domain=$domain' class='btn btn-success btn-xs pull-right order-btn' $buy_new_tab >$additional_button_name</a>";
			...
			if(!$additional_button_name == '' AND !$additional_button_link == ''){
				...
				$additional_button = "<a class='btn btn-success btn-xs pull-right order-btn' href='$additional_button_links' $buy_new_tab >$additional_button_name</a>";
			}else{
				$additional_button = '';
			}
		}else{
...
function wdc_options() {
    ...
    'id' => '_blank1_option',
    'type' => 'checkbox',
    'desc' => 'Open the Whois Link in new tab.',
    'default' => false,
	) );
    ...
    'id' => '_blank2_option',
    'type' => 'checkbox',
    'desc' => 'Open the Integration Link in new tab.',
    'default' => false,
	) );
