...
<?php
	$featured_enable = easyweb_webnus_options::easyweb_webnus_blog_featuredimage_enable();
...
// Post Title
if( easyweb_webnus_options::easyweb_webnus_blog_posttitle_enable() && $post_format !='aside' && $post_format !='quote') { 	
	if( 'link' == $post_format ) {
...
// Post Content
		if($post_format == 'quote' ) echo '<blockquote>';
			...
			echo '<p>'.easyweb_webnus_excerpt((easyweb_webnus_options::easyweb_webnus_blog_excerpt_list())?easyweb_webnus_options::easyweb_webnus_blog_excerpt_list():35).'</p>';
			echo '<a class="readmore" href="' . get_permalink($post->ID) . '">' . esc_html(easyweb_webnus_options::easyweb_webnus_blog_readmore_text()) . '</a>';
