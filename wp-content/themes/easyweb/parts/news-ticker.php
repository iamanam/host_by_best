...
if( easyweb_webnus_options::easyweb_webnus_nt_show() || ( !easyweb_webnus_options::easyweb_webnus_nt_show() && (is_home() || is_front_page() )) ):
	$title = easyweb_webnus_options::easyweb_webnus_nt_title();
	$cat = easyweb_webnus_options::easyweb_webnus_nt_cat();
	$count = easyweb_webnus_options::easyweb_webnus_nt_count();
	$effect= (!easyweb_webnus_options::easyweb_webnus_nt_effect());
	$speed = easyweb_webnus_options::easyweb_webnus_nt_speed();
	$pause = easyweb_webnus_options::easyweb_webnus_nt_pause();
