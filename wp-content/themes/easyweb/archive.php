<?php
	get_header();
	$sidebar = easyweb_webnus_options::easyweb_webnus_blog_sidebar();
	$template = easyweb_webnus_options::easyweb_webnus_blog_template();
...
<?php // start headline
	echo '<section id="headline"><div class="container"><h2>';
		...
		elseif ( is_tag() ):
			...
			echo esc_html(easyweb_webnus_options::easyweb_webnus_blog_page_title());
		endif;
	echo '</h2></div></section>';
 // end headline ?>
